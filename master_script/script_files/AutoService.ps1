...
Get-Service | Where-Object {($_.StartType -like "*Auto*") -and ($_.Status -notlike "*running*")} | Start-Service -ErrorAction SilentlyContinue -ErrorVariable ERR
}

    AutoService     # This will start all automatic Services.