...
function DefAVP {
    ...
    If($AV.AntivirusEnabled -like "*False*"){
      $Body =  $VMINFO
      $Subject = "Windows Defender Antivirus Protection is Disabled On: $Env:ComputerName"
...
function xDefAVP {
    ExecuteFunction -RegKeyName DefAVP -FunctionName $function:DefAVP -IntervalInMins 1440
}




    #xDefAVP          # This Verify the Defender AntiVirus Protection. Email Subject: Windows Defender Antivirus Protection is Disabled On: