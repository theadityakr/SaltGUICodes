...
function xDisableNetworkDiscovery {
    ExecuteFunction -RegKeyName DisableNetworkDiscovery -FunctionName $function:DisableNetworkDiscovery -IntervalInMins 720
}

    xDisableNetworkDiscovery # This Enables Firewall Rule for Network Discovery.